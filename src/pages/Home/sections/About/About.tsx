...
const skills = ["HTML", "CSS", "JavaScript", "React", 'MUI', "TypeScript", "Git", "Selenium", "Python", "C#", 'C++', 'SQL', 'Flask', 'SQLAlchemy', 'Docker', 'Node.js', 'GDScript', 'Unreal Engine', 'Godot Engine', 'Unity Engine', 'Game Design']
